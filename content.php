...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'plainly' ) ); ?>
		<?php
			wp_link_pages( array(
	...
	<footer class="entry-footer">
		...
		<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'plainly' ), __( '1 Comment', 'plainly' ), __( '% Comments', 'plainly' ) ); ?></span>
		<?php endif; ?>
